 ...
 * (optional) inputs feed onboarding state. Continue posts the workspace to
 * the backend (`POST /workspaces/create`) and stays disabled while the
 * request is in flight; Back returns to Welcome; Skip routes to the dashboard.
 */
