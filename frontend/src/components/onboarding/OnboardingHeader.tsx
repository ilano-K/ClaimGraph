 ...
 * onboarding.html TopAppBar: brand, step progress nav, and trailing actions.
 */
export default function OnboardingHeader({ activeStep, totalSteps = 4 }: OnboardingHeaderProps) {
  return (
