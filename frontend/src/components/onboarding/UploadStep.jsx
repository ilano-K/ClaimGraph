...
import { cn, formatBytes, fileExtension, SUPPORTED_FILE_EXTS } from '../../lib/utils.js'
 ...
 * back up to the orchestrator, which feeds them into the Processing step.
 */
export default function UploadStep({ files, error, onAdd, onRemove, onProcess, onBack, onSkip }) {
